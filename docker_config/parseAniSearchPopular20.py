...
OVERSEER_API_KEY = "MTYzOTc4MzU5NzMxMGU5MzI2OWYzLTQ1NjItNGRlMy05YjJjLWIyZDBkNmZhOTliZik="
...
req = Request('https://www.anisearch.de/anime/popular?char=all&syncro=de&view=2&limit=50&hentai=no', headers={'User-Agent': 'Mozilla/5.0'})
webpage = urlopen(req)
...
print("===============================================================")
print("Top 50 german anime results in popular on anisearch.de:              =")
print("===============================================================")
...
req = Request('https://www.anisearch.de/anime/popular?char=all&syncro=ja&view=2&limit=50&hentai=no', headers={'User-Agent': 'Mozilla/5.0'})
webpage = urlopen(req)
sourceCode = webpage.read().decode()
...
print("===============================================================")
print("Top 50 japanese anime results in popular on anisearch.de:              =")
print("===============================================================")
print(animeLinksTextOnlyArray)
print("===============================================================")
for animeTitle in animeLinksTextOnlyArray:
